...
import com.example.ifoodrecommender.data.LoginRepository;
...
public class LoginViewModel extends ViewModel {
    ...
    public void login(String username, String password) {
       ...
       Boolean result = loginRepository.login(username, password);
        ...
        if (result == true) {
            LoggedInUser data = LoginFBDSource.getLoggedInUser();
            loginResult.setValue(new LoginResult(new LoggedInUserView(data.get_uname())));
        } else {
